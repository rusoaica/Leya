...
namespace Leya.ViewModels.Common.Dialogs.MessageBox
{
    public interface IMsgBoxVM : IBaseModel
    {
        ...
        /// <returns>A <see cref="NotificationResult"/> representing the DialogResult of the MessageBox window</returns>
        NotificationResult Show(string text, string caption, NotificationButton messageType);
        ...
        /// <returns>A <see cref="NotificationResult"/> representing the DialogResult of the MessageBox window</returns>
        NotificationResult Show(string text, string caption, NotificationButton messageType, NotificationImage image);
        #endregion
    }
}
