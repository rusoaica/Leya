...
namespace Leya.Views.Common.Styles
{
    public sealed class StyleManager
    {
        ...
        private readonly StyleInclude darkStyle = CreateStyle("avares://Leya/Common/Styles/Dark.xaml");
        private readonly StyleInclude lightStyle = CreateStyle("avares://Leya/Common/Styles/Light.xaml");
        #endregion
        ...
        {
            return new StyleInclude(new Uri("resm:Styles?assembly=Leya"))
            {
                Source = new Uri(url)
            };
        }
