...
namespace Xceed.Wpf.Toolkit.Themes
{
    public static class ResourceKeys
    {
        ...
        public static readonly ComponentResourceKey SpinnerButtonUpStyleKey = new ComponentResourceKey(typeof(ResourceKeys), "SpinnerButtonUpStyleKey");
        public static readonly ComponentResourceKey SpinnerButtonDownStyleKey = new ComponentResourceKey(typeof(ResourceKeys), "SpinnerButtonDownStyleKey");
        public static readonly ComponentResourceKey SpinnerButtonFlatStyleKey = new ComponentResourceKey(typeof(ResourceKeys), "SpinnerButtonFlatStyleKey");
