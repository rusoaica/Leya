    ...
    public partial class AutoCompleteBox : Control, IUpdateVisualState
    {
        ...
        private static void OnMinimumPopulateDelayPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newValue < 0)
            {
                ...
                throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, string.Empty, newValue), "value");
            }
        ...
        /// <summary>
        /// Gets or sets the maximum width of the drop-down portion of the
        /// <see cref="T:System.Windows.Controls.AutoCompleteBox" /> control.
        /// </summary>
        /// <value>The maximum width of the drop-down portion of the
        /// <see cref="T:System.Windows.Controls.AutoCompleteBox" /> control.
        ...
        /// <summary>
        /// Identifies the
        /// <see cref="P:System.Windows.Controls.AutoCompleteBox.MaxDropDownWidth" />
        /// dependency property.
        /// </summary>
        /// <value>The identifier for the
        /// <see cref="P:System.Windows.Controls.AutoCompleteBox.MaxDropDownWidth" />
        ...
        public static readonly DependencyProperty MaxDropDownWidthProperty =
            DependencyProperty.Register(
                ...
                typeof(double),
                typeof(AutoCompleteBox),
                new PropertyMetadata(double.PositiveInfinity, OnMaxDropDownWidthPropertyChanged));
        ...
        private static void OnMaxDropDownHeightPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newValue < 0)
            {
                ...
                throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, string.Empty, e.NewValue), "value");
            }
            source.OnMaxDropDownHeightChanged(newValue);
        }

        /// <summary>
        /// MaxDropDownWidthProperty property changed handler.
        /// </summary>
        /// <param name="d">AutoCompleteTextBox that changed its MaxDropDownHeight.</param>
        /// <param name="e">Event arguments.</param>
        [SuppressMessage("Microsoft.Usage", "CA2208:InstantiateArgumentExceptionsCorrectly", Justification = "The exception will be called through a CLR setter in most cases.")]
        private static void OnMaxDropDownWidthPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            AutoCompleteBox source = d as AutoCompleteBox;
            if (source._ignorePropertyChange)
            {
            ...
            source.OnMaxDropDownWidthChanged(newValue);
        }
        ...
        public bool SearchItem<T>(string search, T item)
        {
            return (item as SearchEntity).Text.ToLower().Contains(search.ToLower()) || ((item as SearchEntity).Value?.ToString().ToLower().Contains(search.ToLower()) ?? false);
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (popup != null)
            {
                ...
                DropDownPopup.MaxDropDownWidth = MaxDropDownWidth;
        ...
        /// <summary>
        /// Handles MaxDropDownWidthChanged by re-arranging and updating the 
        /// popup arrangement.
        /// </summary>
        /// <param name="newValue">The new value.</param>
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "newValue", Justification = "This makes it easy to add validation or other changes in the future.")]
        private void OnMaxDropDownWidthChanged(double newValue)
        {
            if (DropDownPopup != null)
            {
                DropDownPopup.MaxDropDownWidth = newValue;
                DropDownPopup.Arrange();
            }
            UpdateVisualState(true);
        }
